      ...
      VStack(spacing: 20) {
        ...
        VStack(spacing: 0) {
          Text(textTitle)
            ...
            .padding()
          Text(
            "Siparişiniz başarıyla alındı.Müşteri temsilcilerimiz en kısa sürede siparişinizle ilgili detayları kontrol edecek ve işleme alacaklar. İlginiz ve güveniniz için teşekkür ederiz."
          )
          .font(.title3)
          .fontWeight(.light)
