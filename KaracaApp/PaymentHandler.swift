...
class PaymentHandler: NSObject {
    ...
    func shippingMethodCalculator() -> [PKShippingMethod] {
        ...
        if let shippingEnd = shippingEnd, let shippingStart = shippingStart {
            ...
            let shippingDelivery = PKShippingMethod(label: "", amount: NSDecimalNumber(string: "0.00"))
            shippingDelivery.dateComponentsRange = PKDateComponentsRange(start: startComponents, end: endComponents)
            shippingDelivery.detail = "Adresinize gönderilecek ürünler"
            shippingDelivery.identifier = "Teslimat"
    ...
    func startPayment(products: [Product], total: Int, completion: @escaping PaymentCompletionHandler) {
        ...
        let total = PKPaymentSummaryItem(label: "Toplam", amount: NSDecimalNumber(string: "\(total)"), type: .final)
        ...
        paymentRequest.merchantIdentifier = "merchant.com.zekibaklan.KaracaApp"
